...
export const CHAT_EVENT_TYPES = ["text_delta", "assistant_text", "tool_use", "tool_result", "notice", "error", "permission_request", "user_text", "complete", "new_session", "session_id", "theme", "status", "statusline_picker", "done"] as const;
